...
{
  slug: 'ferrari-f40-the-last-car-enzo-ferrari-approved',
  date: '2026-09-14',
  updated: '2026-09-14',
  eyebrow: '14/09/2026 in Car Stories',
  title: 'Ferrari F40: The Last Car Enzo Ferrari Approved',
  metaTitle: 'Ferrari F40: The Last Car Enzo Ferrari Approved',
  metaDescription: 'The Ferrari F40 was the last car Enzo Ferrari approved, the first road car to break 200 mph, and one of the purest supercars ever built. Here is the story.',
  focusKeyword: 'Ferrari F40',
  // excerpt: 'The last car Enzo Ferrari signed off was the most stripped back Ferrari ever built, and the first road car to break 200 mph. This is the F40 story.',
  coverImage: '/Ferrari-F40-blog/Ferrari F40 front.jpg',
  coverImageAlt: 'Red Ferrari F40 front view parked in an Italian piazza',
  content: [
    { type: 'paragraph', text: 'The Ferrari F40 was the last car Enzo Ferrari signed off before he died, and he made it the most stripped back Ferrari ever built. Anything that did not make it faster was left out. What remained was a twin turbo V8, a body you could see the weave through, and the first production car in history to pass 200 mph. There is a reason people still call it the greatest supercar ever made.' },
    { type: 'heading', text: 'Enzo wanted one last statement' },
    { type: 'paragraph', text: 'By 1987 Ferrari was 40 years old and Enzo was 88. He wanted to mark the anniversary with something that reminded everyone what the badge stood for. Not comfort. Not gadgets. Speed, and nothing in the way of it.' },
    { type: 'paragraph', text: 'He got it. When the red sheet came off at the Civic Centre in Maranello, the room went quiet, then broke into applause. It was the last car Enzo Ferrari personally approved. He died the following year.' },
    { type: 'heading', text: 'It was born from a dead race program' },
    { type: 'paragraph', text: 'The F40 did not start as a birthday present. It started as a race car with nowhere to race. In the mid 1980s Ferrari built the 288 GTO to compete in Group B, the wild top tier of rallying. Then a string of fatal crashes made the sport pull the plug on Group B in 1986. Ferrari was left with five highly developed 288 GTO Evoluzione prototypes and no series to run them in.' },
    { type: 'paragraph', text: 'Engineer Nicola Materazzi convinced Enzo not to waste them. Take that race car, he argued, and turn it into the hardest road car Ferrari had ever built. Working with Pininfarina on the body, the team went from idea to finished car in about thirteen months.' },
    { type: 'image', src: '/Ferrari-F40-blog/Ferrari F40 front-close.jpg', alt: 'Red Ferrari F40 front close up showing the racing stripe and low nose', credit: 'Ferrari' },
    { type: 'heading', text: 'What engine the Ferrari F40 uses' },
    { type: 'paragraph', text: 'Behind the driver sits a 2.9 liter twin turbocharged V8, developed from the 288 GTO engine. It makes around 471 horsepower at 7,000 rpm and 426 lb ft of torque. Those numbers do not sound wild today. The way they arrive is the point. Below 3,500 rpm the car feels almost calm. Then both turbos come on boost at once and it turns into something else entirely. It was also Ferrari\'s last turbocharged road car engine until the California T arrived in 2014.' },
    { type: 'heading', text: 'The first road car to break 200 mph' },
    { type: 'paragraph', text: 'Ferrari claimed a top speed of 201 mph. That made the F40 the first production car to officially pass the 200 mph mark. Zero to 60 mph came in a little over four seconds. The speed came from a hard rule the whole car followed. Add power, then take away everything that slows it down.' },
    { type: 'image', src: '/Ferrari-F40-blog/Ferrari Rear.jpg', alt: 'Rear of a red Ferrari F40 parked beside an old brick building', credit: 'Ferrari' },
    { type: 'heading', text: 'Built light, on purpose' },
    { type: 'paragraph', text: 'The body is Kevlar, carbon fiber, and aluminum over a tubular steel frame. The windshield and windows are plastic. Even the paint was sprayed thin. Look closely at an early car and you can see the weave of the composite through it. Dry weight came in around 1,100 kilograms. That is featherweight for a supercar, then or now, and it is the real reason the F40 feels so alive.' },
    { type: 'heading', text: 'Inside, there is almost nothing' },
    { type: 'paragraph', text: 'Open the door with the pull cord, because there is no handle, and the cabin makes the whole idea obvious. No leather. No carpet. No sound system. Bare composite floor with the weave on show. Early cars had sliding plastic windows lifted straight from a race car. Air conditioning was the one concession, and only because the engine behind your head runs so hot.' },
    { type: 'heading', text: 'It went racing after all' },
    { type: 'paragraph', text: 'The road car was so close to a race car that turning it back into one took little work. Ferrari built the F40 LM, then the Competizione, then the GTE. An F40 LM finished third on its IMSA debut at Laguna Seca in 1989, driven by Jean Alesi, beating a field of purpose built specials. In the BPR Global GT Series the F40 took wins at Vallelunga and Anderstorp before the McLaren F1 GTR arrived and moved the game on.' },
    { type: 'heading', text: 'What a Ferrari F40 is worth now' },
    { type: 'paragraph', text: 'Ferrari planned to build 400. Demand and speculation pushed that to around 1,311 cars, with 213 sold in the United States. It listed at close to 400,000 dollars in 1987. Prices crashed when the early 1990s bubble burst, then climbed for decades. Good road cars now trade between roughly 2.5 million and 4 million dollars, with the best examples higher. The rare LM race cars are in another bracket, with one selling for about 11 million dollars in 2025.' },
    { type: 'heading', text: 'Why the Ferrari F40 still matters' },
    { type: 'paragraph', text: 'The F40 is the car people point to when they explain what a supercar felt like before computers softened the edges. No traction control to catch you. No screens. Nothing between your right foot and the road. Every Ferrari since has moved further from that idea, which is exactly why this one still holds the top spot for so many people. It was the last car Enzo approved, and he made sure it was the purest.' },
   ],
  faq: [
    { q: 'How many Ferrari F40s were built?', a: 'Around 1,311 in total between 1987 and 1992, with 213 sold in the United States. Ferrari had originally planned just 400.' },
    { q: 'What engine does the Ferrari F40 have?', a: 'A 2.9 liter twin turbocharged V8, making about 471 horsepower and 426 lb ft of torque.' },
    { q: 'Was the Ferrari F40 the first 200 mph car?', a: 'Yes. With a claimed top speed of 201 mph, it was the first production car to officially break 200 mph.' },
    { q: 'What is a Ferrari F40 worth today?', a: 'Good road cars trade between roughly 2.5 million and 4 million dollars. Rare LM race cars go far higher, with one selling for about 11 million.' },
  ],
  relatedPosts: ['the-ultimate-ferrari-laferrari', 'mclaren-f1-gtr-the-road-car-that-won-le-mans', 'the-pagani-zonda-c12-how-one-man-built-his-dream'],
  tags: ['Ferrari F40', 'Ferrari', 'Car Stories'],
  source: 'Source: Ferrari, Car and Driver',
}, {
  slug: 'pagani-zonda-s-roadster-the-first-open-top-pagani',
  date: '2026-09-22',
  updated: '2026-09-22',
  eyebrow: '22/09/2026 in Car Stories',
  title: 'Pagani Zonda S Roadster: The First Open Top Pagani',
  metaTitle: 'Pagani Zonda S Roadster: The First Open Top Pagani',
  metaDescription: 'The Pagani Zonda S Roadster was the first open top Pagani, a 7.3 AMG V12 with almost no weight gain over the coupe and only around a dozen built. The story.',
  focusKeyword: 'Pagani Zonda S Roadster',
  // excerpt: 'Pagani cut the roof off its wildest supercar without breaking it. Same 7.3 V12, barely any extra weight, and one of the rarest Zondas ever built.',
  coverImage: '/Zonda-S-Roadster-blog/Pagani Zonda S Roadster front.png',
  coverImageAlt: 'Pagani Zonda S Roadster front view',
  content: [
    { type: 'paragraph', text: 'The Pagani Zonda S Roadster took the wildest supercar of its day and cut the roof off without breaking it. Same 7.3 liter AMG V12. Same shattering pace. Barely any extra weight. It was the first open top car Pagani ever built, and it is one of the rarest Zondas of all.' },
    { type: 'heading', text: 'Cutting the roof off is the hard part' },
    { type: 'paragraph', text: 'Turning a coupe into a convertible usually costs you. Take the roof away and the body flexes, so most makers bolt in heavy bracing to put the stiffness back. That adds weight, and weight is the enemy of everything a Zonda stands for.' },
    { type: 'paragraph', text: 'Pagani refused to play it that way. Instead of loading up the sills with reinforcement, the team strengthened the firewall and the windscreen frame and tied it all together with billet alloy braces where the roof rails used to sit. The result is a roadster that weighs almost the same as the coupe. Pagani quoted a gain of around 30 kilograms. For an open car, that is close to nothing.' },
    { type: 'heading', text: 'What engine the Zonda S Roadster uses' },
    { type: 'paragraph', text: 'Behind the seats sits the engine that made the Zonda a legend, the Mercedes AMG 7.3 liter V12. It is one of the largest V12s ever put in a road car, and here it makes 555 horsepower and 553 lb ft of torque. Power runs through a six speed manual to the rear wheels. Zero to 60 mph takes about 3.7 seconds and the top speed sits north of 200 mph. Traction control and ABS were standard, there to manage the power rather than hide it.' },
    { type: 'image', src: '/Zonda-S-Roadster-blog/Pagani Zonda S Roadster front 2.jpg', alt: 'Pagani Zonda S Roadster front view showing the low wide stance', credit: 'Pagani' },
    { type: 'image', src: '/Zonda-S-Roadster-blog/Pagani Zonda S Roadster front 4.png', alt: 'Pagani Zonda S Roadster parked, front three-quarter view', credit: 'Pagani' },
    { type: 'heading', text: 'A removable carbon roof' },
    { type: 'paragraph', text: 'The roof is a single carbon fiber panel that lifts off by hand. It weighs next to nothing and stows away, so the Zonda goes from closed coupe to open roadster in a couple of minutes. Pagani also reworked the aerodynamics for the open body, adding a pair of NACA ducts to the rear engine cover to feed air where it was needed. The elliptical roll bar is built from carbon fiber and chrome molybdenum alloy, tied straight into the rear of the chassis for safety.' },
    { type: 'heading', text: 'Built like a jewel' },
    { type: 'paragraph', text: 'The Zonda has always been about more than numbers. Horacio Pagani calls his cars Una Macchina con Anima, a car with a soul, and the Roadster is where that shows. The cabin is hand stitched leather, aluminum machined from solid, and carbon fiber everywhere you look. The gauges overlap in a sculpted alloy pod. The toggle switches were modeled on an old Alfa Romeo. Every car was built to its owner\'s taste, like a tailored suit.' },
    { type: 'heading', text: 'How rare the Zonda S Roadster is' },
    { type: 'paragraph', text: 'Pagani announced a run of 40 Roadsters. The reality is far smaller. The factory has since confirmed that only around a dozen of the 7.3 S Roadsters were actually built, which makes it one of the scarcest Zondas ever made. That rarity shows in the values. Good examples now trade into the millions, and a right hand drive car is rarer still, with only a handful ever converted.' },
    { type: 'image', src: '/Zonda-S-Roadster-blog/Pagani Zonda S Roadster front 3.jpg', alt: 'Pagani Zonda S Roadster front three-quarter view', credit: 'Pagani' },
    { type: 'heading', text: 'It drives better than it should' },
    { type: 'paragraph', text: 'A car this fast and this rare could be a nightmare to use. The Zonda is the opposite. Road testers came away surprised at how easy it is to drive slowly, with light controls, a smooth clutch, and a clear view out over the front wheels. Then you open it up and it turns into something close to a Formula 1 car for the road. That mix, savage when you want it and calm when you do not, is exactly what Horacio Pagani was chasing.' },
    { type: 'heading', text: 'Why the Zonda S Roadster matters' },
    { type: 'paragraph', text: 'The Roadster proved Pagani could build an open supercar without giving anything up. No lost performance, no bloated weight, no compromise on craft. It set the template for every open Pagani that followed, right through to the Huayra Roadster. It is the first time Pagani took the roof off, and more than twenty years later it still looks like it landed from the future.' },
  ],
  faq: [
    { q: 'How many Pagani Zonda S Roadsters were built?', a: 'Pagani announced 40, but the factory has confirmed only around a dozen of the 7.3 S Roadster were actually built.' },
    { q: 'What engine does the Zonda S Roadster use?', a: 'A Mercedes AMG 7.3 liter V12, making 555 horsepower and 553 lb ft of torque, through a six speed manual.' },
    { q: 'How fast is the Pagani Zonda S Roadster?', a: 'Zero to 60 mph in about 3.7 seconds, with a top speed north of 200 mph.' },
    { q: 'Was the Zonda S Roadster the first open top Pagani?', a: 'Yes. Launched in 2003, it was the first roadster Pagani ever built.' },
  ],
